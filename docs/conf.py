...
htmlhelp_basename = 'ckpttncppdoc'
...
latex_documents = [
  (master_doc, 'ckpttncpp.tex', u'ckpttncpp Documentation',
...
man_pages = [
    (master_doc, 'ckpttncpp', u'ckpttncpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ckpttncpp', u'ckpttncpp Documentation',
   author, 'ckpttncpp', 'One line description of project.',
   'Miscellaneous'),
]
