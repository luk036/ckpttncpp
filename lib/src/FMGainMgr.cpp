...
FMGainMgr<GainCalc, Derived>::
FMGainMgr(Netlist &H, std::uint8_t K)
 ...
 */
template <typename GainCalc, class Derived>
auto FMGainMgr<GainCalc, Derived>::
select(const std::vector<std::uint8_t> &part) -> std::tuple<MoveInfoV, int> {
...
template <typename GainCalc, class Derived>
auto FMGainMgr<GainCalc, Derived>::
select_togo(std::uint8_t toPart) -> std::tuple<node_t, int> {
...
template <typename GainCalc, class Derived>
auto FMGainMgr<GainCalc, Derived>::
init(const std::vector<std::uint8_t> &part) -> void
{
...
template <typename GainCalc, class Derived>
auto FMGainMgr<GainCalc, Derived>::
update_move(const std::vector<std::uint8_t> &part,
